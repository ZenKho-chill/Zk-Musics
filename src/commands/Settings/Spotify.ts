      ...
      const embed = new EmbedBuilder()
        .setTitle(
          `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_feature_disabled_title"
          )}`
        )
        .setDescription(
          `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_feature_disabled_desc",
            {
      ...
      if (!spotifyID) {
        await handler.interaction.reply({
          content: `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_connect_provide_id"
          )}`,
          flags: MessageFlags.Ephemeral,
        });
        return;
      ...
      try {
        ...
        await handler.interaction.reply({
          content: `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_connect_success",
            {
        ...
        await handler.interaction.reply({
          content: `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_connect_error"
          )}`,
          flags: MessageFlags.Ephemeral,
        });
      }
      ...
      if (!existingSpotifyID) {
        await handler.interaction.reply({
          content: `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_disconnect_not_connected"
          )}`,
          flags: MessageFlags.Ephemeral,
        });
        return;
      ...
      try {
        ...
        await handler.interaction.reply({
          content: `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_disconnect_success"
          )}`,
          flags: MessageFlags.Ephemeral,
        });
      } catch (error) {
        ...
        await handler.interaction.reply({
          content: `${client.i18n.get(
            handler.language,
            "client.commands",
            "settings.spotify_disconnect_error"
          )}`,
          flags: MessageFlags.Ephemeral,
        });
      }
