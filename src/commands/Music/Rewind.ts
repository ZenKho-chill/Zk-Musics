...
export default class implements Command {
  public name = ["rewind"];
  public description = "Lùi thời gian trong bài hát! (10s)";
  public category = "Âm nhạc";
  public accessableby = data.COMMANDS_ACCESS.MUSIC.Rewind;
  public usage = "";
  public aliases = [];
  ...
  public async execute(client: Manager, handler: CommandHandler) {
    ...
    if (song_position - rewindNum * 1000 > 0) {
      ...
      const rewind2 = new EmbedBuilder()
        .setDescription(
          `${client.i18n.get(handler.language, "client.commands.music", "playback.rewind.msg", {
      ...
      return handler.editReply({
        embeds: [
          new EmbedBuilder()
            .setDescription(
              `${client.i18n.get(handler.language, "client.commands.music", "playback.rewind.beyond")}`
            )
            .setColor(client.color_main),
        ],
      });
