...
export default class implements Command {
  public name = ["forcejoin"];
  public description = "Ép bot tham gia kênh thoại";
  public category = "Music";
  public accessableby = data.COMMANDS_ACCESS.MUSIC.ForceJoin;
  public usage = "";
  public aliases = ["fj"];
  ...
  public async execute(client: Manager, handler: CommandHandler) {
    ...
    if (!player) {
      ...
      // Nếu player đã tồn tại, đặt lại kênh thoại
      await player.setVoiceChannel(handler.member!.voice.channel!.id);
    }
