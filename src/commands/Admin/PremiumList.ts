  ...
  public async execute(client: Manager, handler: CommandHandler) {
    ...
    if (!["user", "guild"].includes(type))
      return handler.editReply({
        embeds: [
          new EmbedBuilder()
            .setDescription(
              `${client.i18n.get(handler.language, "client.commands.admin.premium", "list_invalid_type", {
    ...
    for (let i = 0; i < pagesNum; i++) {
      ...
      const embed = new EmbedBuilder()
        ...
        .setColor(client.color_main)
        .setDescription(str == "" ? client.i18n.get(handler.language, "client.commands.admin.premium", "list_no_data") : "\n" + str)
        .setFooter({
    ...
    if (pageNum >= pagesNum)
      return handler.editReply({
        embeds: [
          new EmbedBuilder()
            .setDescription(
              `${client.i18n.get(handler.language, "client.commands.admin.premium", "list_page_not_found", {
