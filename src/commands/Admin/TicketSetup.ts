...
export default class implements Command {
  ...
  public async execute(client: Manager, handler: CommandHandler) {
    ...
    const channel = handler.interaction.guild?.channels.cache.get(
      dataChannel?.id!
    );
    const openCategory = handler.interaction.guild?.channels.cache.get(
      openCategoryData?.id!
    );
    const closeCategory = handler.interaction.guild?.channels.cache.get(
      closeCategoryData?.id!
    );
    ...
    const button = new ActionRowBuilder<ButtonBuilder>().addComponents(
      new ButtonBuilder()
        .setCustomId(
          `ticket-setup-${handler.interaction.guild?.id}-${openCategory.id}`
        )
        .setLabel("Tạo Ticket")
    ...
    const titleInput = new TextInputBuilder()
      ...
      .setLabel(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_label_embed_title"
        )
      )
      ...
      .setPlaceholder(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_placeholder_embed_title"
        )
      )
      .setRequired(true);
    ...
    const descriptionInput = new TextInputBuilder()
      ...
      .setLabel(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_label_embed_description"
        )
      )
    ...
    const thumbnailInput = new TextInputBuilder()
      ...
      .setLabel(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_label_embed_thumbnail_url"
        )
      )
      .setStyle(TextInputStyle.Short)
      .setPlaceholder(
    ...
    const imageInput = new TextInputBuilder()
      ...
      .setLabel(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_label_embed_image_url"
        )
      )
      .setStyle(TextInputStyle.Short)
      .setPlaceholder(
    ...
    const footerInput = new TextInputBuilder()
      ...
      .setLabel(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_label_embed_footer"
        )
      )
      .setStyle(TextInputStyle.Short)
      .setPlaceholder(
        client.i18n.get(
          handler.language,
          "events.ticket",
          "ticket_setup_placeholder_embed_footer"
        )
      )
      .setRequired(false);
    ...
    try {
      const submitted = await handler.interaction
        .awaitModalSubmit({
          ...
          filter: (i) =>
            i.customId ===
              `ticket-embed-modal-${handler.interaction.guild!.id}` &&
      ...
      const embedDescription =
        submitted.fields.getTextInputValue("embed_description");
      const thumbnailURL =
        submitted.fields.getTextInputValue("embed_thumbnail");
